...
Dans l'exemple ci-dessus, nous avons explicité le constructeur-copie pour répliquer parfaitement le comportement implicite donné par défaut à ce dernier par l'environnement. Nous rencontrerons dans la chapitre \ref{chap:memory1} des exemples de cas dans lesquels il est nécessaire de donner un sens plus spécifique à ce constructeur-copie.\\ 